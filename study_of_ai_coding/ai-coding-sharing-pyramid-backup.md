...
#### 1.4 第四代：Subagent协作系统

##### 核心理念
从"单打独斗"到"团队协作"，利用多个专门化的AI Agent协同工作。
...
- 支持多种模型（Claude Opus 4.5、GPT-5.2、Gemini 3）
- 22个生命周期钩子，11+ LSP/AST工具

**核心Agent**：
| Agent | 模型 | 核心价值 | 使用场景 |
|-------|-------|---------|---------|
| **Sisyphus** | Claude Opus 4.5 | 主编排器 | 复杂任务全流程管理 |
| **Oracle** | GPT-5.2 | 策略分析 | 架构设计、调试、代码审查 |
| **Librarian** | Claude Sonnet 4.5 | 文档查阅 | 查找最佳实践、理解代码 |
| **Explore** | Grok Code / Gemini 3 Flash | 快速搜索 | 理解项目结构、代码模式匹配 |
| **Frontend UI/UX Engineer** | Gemini 3 Pro | 前端设计 | 组件开发、页面布局、样式设计 |

#### 1.5 工具演进总结

| 代际 | 代表工具 | 核心特征 | 效率提升 | 局限性 |
|------|---------|---------|---------|--------|
| **第一代** | GitHub Copilot | 代码补全 | 1.5-2x | 无自主性 |
| **第二代** | Cursor、Cline | IDE集成，自主执行 | 2-3x | 学习成本，质量不稳定 |
| **第三代** | aider、Continue | 命令行，精确控制 | 2-3x | 需要技术能力 |
| **第四代** | OpenCode、Oh My OpenCode | 多Agent协作 | 3-5x | 复杂度高 |

#### 1.6 工具选择建议

| 场景 | 推荐工具 | 理由 |
|------|---------|------|
| **日常编码补全** | GitHub Copilot | 无干扰、快速响应 |
| **新功能开发** | Cursor / Cline | 多文件理解、自主执行 |
| **大型重构** | aider | Git集成、可控性强 |
| **团队协作** | OpenCode + Subagents | 专业分工、质量可控 |
| **追求极致效率** | Oh My OpenCode | 多模型编排、并行执行 |
